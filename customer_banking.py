...
def main():
    ...
    savings_maturity = int(input('What is the length of months for your CD? '))
    ...
    print("The Interest is: $", format(interest_earned, ',.2f'))
    ...
    cd_interest_rate = float(input('What is the APR for the CD account? '))
    ...
    print("The Cd Interest is: $", format(cd_interest_earned, ',.2f'))
    print("The new balance is: $", format(updated_cd_balance, ',.2f'))
